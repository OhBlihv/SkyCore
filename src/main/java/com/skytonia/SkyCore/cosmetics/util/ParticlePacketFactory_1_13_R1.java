...
import com.skytonia.SkyCore.cosmetics.util.ParticlePacket.ParticlePacket_1_13_R1;
import org.bukkit.util.Vector;

public class ParticlePacketFactory_1_13_R1 implements IParticlePacketFactory
{
	...
	{
		return new ParticlePacket_1_13_R1(effect, offsetX, offsetY, offsetZ,
	...
	public ParticlePacket getParticlePacket(ParticleEffect effect, Vector direction, float speed, boolean longDistance,
	                                        ParticleEffect.ParticleData data) throws IllegalArgumentException
	{
		return new ParticlePacket_1_13_R1(effect, direction, speed, longDistance, data);
	}

	@Override
	public ParticlePacket getParticlePacket(ParticleEffect effect, ParticleEffect.ParticleColor color, boolean longDistance)
	{
		return new ParticlePacket_1_13_R1(effect, color, longDistance);
	}

 ...
 */
public class ParticlePacket_1_13_R1 extends ParticlePacket
{

	private PacketPlayOutWorldParticles particlePacket;

	public ParticlePacket_1_13_R1(ParticleEffect effect, float offsetX, float offsetY, float offsetZ, float speed, int amount, boolean longDistance, ParticleEffect.ParticleData data) throws IllegalArgumentException
	{
		super(effect, offsetX, offsetY, offsetZ, speed, amount, longDistance, data);
	}

	public ParticlePacket_1_13_R1(ParticleEffect effect, Vector direction, float speed, boolean longDistance, ParticleEffect.ParticleData data) throws IllegalArgumentException
	{
		super(effect, (float) direction.getX(), (float) direction.getY(), (float) direction.getZ(), speed, 0, longDistance, data);
	}

	public ParticlePacket_1_13_R1(ParticleEffect effect, ParticleEffect.ParticleColor color, boolean longDistance)
	{
